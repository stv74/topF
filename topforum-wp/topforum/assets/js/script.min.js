...
!(function (e, t) {
                    ...
                    if (((n = n || []), 1 === f.length)) {
                        ...
                        for (
                            ...
                            if (
                                ...
                                (o = u(
                                    c.matches[0].replace(te, ne),
                                    (ee.test(l[0].type) && ye(t.parentNode)) ||
                                        t
                                ))
                            ) {
            ...
            function (e, t) {
                x.fn[e] = function (n, i) {
                    ...
                    return (
                        ...
                        1 < this.length &&
                            (H[e] || x.uniqueSort(o), N.test(e) && o.reverse()),
                        this.pushStack(o)
                    );
                };
            }
    ...
    function Ne(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            Q.hasData(e) &&
                ((r = Q.access(e)), (s = x.extend({}, r)), Q.set(t, s));
        }
    }
    function He(e, t, n, i) {
        t = r(t);
        var o,
            ...
            v = t[0],
            y = h(v);
        if (y || (1 < p && "string" == typeof v && !f.checkClone && Ae.test(v)))
            return e.each(function (o) {
                var r = e.eq(o);
                y && (t[0] = v.call(this, o, r.html())), He(r, t, n, i);
            });
        if (
            p &&
            ...
            for (l = (a = x.map(ve(o, "script"), De)).length; u < p; u++)
                (c = o),
                    u !== g &&
                        ((c = x.clone(c, !0, !0)),
            ...
            if (l)
                for (
                    d = a[a.length - 1].ownerDocument, x.map(a, Le), u = 0;
                    u < l;
                    u++
                )
                    (c = a[u]),
                        he.test(c.type || "") &&
                            ...
                            (c.src && "module" !== (c.type || "").toLowerCase()
                                ...
                                : m(c.textContent.replace(Ee, ""), c, d));
        }
        return e;
    }
    function Oe(e, t, n) {
    ...
    x.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n)
                    for (
                        r = r || ve(e), s = s || ve(d), i = 0, o = r.length;
                        i < o;
                        i++
                    )
                        Ne(r[i], s[i]);
        ...
        x.fn.extend({
            ...
            empty: function () {
                for (var e, t = 0; null != (e = this[t]); t++)
                    1 === e.nodeType &&
                        (x.cleanData(ve(e, !1)), (e.textContent = ""));
                return this;
            },
            clone: function (e, t) {
                return (
        ...
        x.each(
            ...
            function (e, t) {
                x.fn[e] = function (e) {
                    for (
                        var n, i = [], o = x(e), r = o.length - 1, a = 0;
                        a <= r;
                        a++
                    )
        ...
        trigger: function (t, n, i, o) {
            ...
            if (
                ...
                3 !== i.nodeType &&
                    ...
                    (-1 < m.indexOf(".") &&
                        ((m = (w = m.split(".")).shift()), w.sort()),
                    (c = m.indexOf(":") < 0 && "on" + m),
                    ((t = t[x.expando]
                        ? t
                        : new x.Event(m, "object" == typeof t && t)).isTrigger =
                        o ? 2 : 3),
                    (t.namespace = w.join(".")),
                ...
                for (r = 0; (s = y[r++]) && !t.isPropagationStopped(); )
                    (f = s),
                        (t.type = 1 < r ? l : p.bindType || m),
                        (u =
                            (G.get(s, "events") || Object.create(null))[
                                t.type
            ...
            ajax: function (t, n) {
                ...
                function C(t, n, s, l) {
                    ...
                    c ||
                        ...
                        (S.statusText = (n || k) + ""),
                        u
                            ? y.resolveWith(h, [p, k, S])
                            : y.rejectWith(h, [S, k, v]),
                        S.statusCode(w),
                        (w = void 0),
                        d &&
